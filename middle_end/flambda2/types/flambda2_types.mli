...
module Typing_env : sig
  ...
  val add_is_int_for_scrutinee : t -> Simple.t -> scrutinee:Simple.t -> t

  val add_is_null_for_scrutinee : t -> Simple.t -> scrutinee:Simple.t -> t

  val add_get_tag_for_block : t -> Simple.t -> block:Simple.t -> t
