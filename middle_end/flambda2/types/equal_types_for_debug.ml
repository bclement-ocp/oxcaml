...
let rec equal_type env t1 t2 =
  ...
  | Some simple1, Some simple2 -> (
    ...
    | Some (var1, coercion1), Some (var2, coercion2) ->
      ...
      in
      Coercion.is_id coercion
      && (not (exists_in_parent_env env (Name.var var2)))
      && (not (exists_in_parent_env env (Name.var var1)))
      && link env.renaming var1 var2)
