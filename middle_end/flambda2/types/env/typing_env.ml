...
module One_level : sig
  ...
  val clean_for_export :
    t -> reachable_names:Name_occurrences.t -> Cached_level.exported
...
module Serializable : sig
  ...
  let create (env : Pre_serializable.t) ~reachable_names : t =
    let names_to_types, symbol_projections =
  ...
  let create_from_closure_conversion_approx (type a) ~machine_width
      (symbols : a Value_approximation.t Symbol.Map.t) : t =
  ...
  let free_function_slots_and_value_slots
      { names_to_types; symbol_projections; _ } =
